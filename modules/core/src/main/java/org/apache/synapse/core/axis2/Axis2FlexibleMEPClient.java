    ...
    public static void send(
        ...
        if (synapseOutMessageContext.getProperty(SynapseConstants.BLOCKING_MSG_SENDER) != null) {
            ...
            if (endpoint != null) {
                        ...
                        if (trpContentType != null && !trpContentType
                            ...
                            try {
                                ...
                                if (contentType.getParameter(HTTPConstants.CHAR_SET_ENCODING) != null) {
                                    strCharSetEncoding =
                                            "; charset=" + contentType.getParameter(HTTPConstants.CHAR_SET_ENCODING);
                                }
                ...
                // HTTP Endpoint : use the specified HTTP method and remove REST_URL_POSTFIX,
                // it's not supported in HTTP Endpoint
