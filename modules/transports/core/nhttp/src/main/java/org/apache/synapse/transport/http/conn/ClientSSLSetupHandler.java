...
public class ClientSSLSetupHandler implements SSLSetupHandler {
    ...
    public void initalize(SSLEngine sslengine) {
        ...
        */
        ...
        /*
            set enabled Cipher suites if they are specified in transport configuration.
            eg: <parameter name="PreferredCiphers">TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384,TLS_RSA_WITH_AES_256_CBC_SHA256</parameter>
        */
